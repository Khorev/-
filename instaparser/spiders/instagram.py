...
class InstagramSpider(scrapy.Spider):
    ...
    insta_login = 'young_ai_new'
    insta_pwd = '#PWD_INSTAGRAM_BROWSER:10:1595104568:AdVQAO35dDn9pd/lZGbrqRUg1itzWUnPuavqbwY7MBcQsI9gTeYf6c/f9ldXJUpszkhF+Cjv/cdDCuIZ74vcwZD+CZxZD2kOtu+5R1j1d5jyLlGpIdokFKX+o1w3wHlsMKn/AlxJ9lgq9ITYwf0K/sU='
    ...
    def user_parse(self, response: HtmlResponse):
        ...
        print(j_body)
        print(f'username:{self.parse_user}')
